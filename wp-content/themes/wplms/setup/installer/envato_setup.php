...
if ( ! class_exists( 'Envato_Theme_Setup_Wizard' ) ) {
	...
	class Envato_Theme_Setup_Wizard {
		...
		public function init_globals() {
			...
			$this->features = array(
	                    		...
	                    		'courses'=>array(
	                    						...
	                    						'verify'=>array('wplms_plugin/loader.php','vibebp/loader.php','buddypress/bp-loader.php','bp-classic/class-bp-classic.php')
                    						),
	                    		'woocommerce'=>array(
			...
			$this->site_styles = apply_filters('wplms_demo_styles',array(
				...
				'learningcenter' => array(
					...
					'version'=>4,
					'src' => 'https://cdn.vibethemes.com/demoimages/learningcenter_full_demo.png',
					'installation_type'=>array('instructor','mooc','academy','university'),
					'link'=>'https://learningcenter.wplms.io',
					'plugins'=>array('vibebp','wplms_plugin','buddypress','bbpress','vibe-helpdesk','vibedrive','elementor')
				),
				'quizmaster' => array(
					'label'=>'Quiz Master',
					'version'=>4,
					'src' => 'https://cdn.vibethemes.com/demoimages/quizmaster_full_demo.png',
				...
				'demo_4_academy' => array(
					'label'=>'Demo Academy',
					'version'=>4,
					'src' => 'https://cdn.vibethemes.com/demoimages/academy_full_demo.png',
					'installation_type'=>array('instructor','mooc','academy'),
					'link'=>'https://academy.demos.wplms.io/',
					'plugins'=>array('vibebp','wplms_plugin','buddypress','bbpress','vibe-helpdesk','vibedrive','elementor')
				),
				...
				'demo_4' => array(
					'label'=>'Demo 4',
					'version'=>4,
					'src' => 'https://cdn.vibethemes.com/demoimages/base_full_demo.png',
		...
		public function envato_page_setup(){
			...
			if(!function_exists('vibebp_get_setting')){
				?><span style="background:#414;color:#fff;padding:10px;border-radius:10px; gap:10px;display:flex;align-items:center;justify-content: space-between;">VibeBP function not active. Please go back to previous step and reactivate the plugin. <a style="background:#fff;padding:8px;border-radius:5px;" href="<?php echo esc_url( $this->get_previous_step_link() ); ?>">Previous Step</a></span><?php
			}
	...
	public function setup_wizard_header() {
			...
			if ( ! $upload || $upload['error'] ) {
				...
				if ( empty( $this->debug ) ) {
					...
					if( !empty($path) ){
						...
						if(strpos($url, 'http://local.wordpress.dev') !== false || strpos($url, 'http://themes.vibethemes.com') !== false){
		...
		function _content_install_slider(){
			...
			$url = 'https://cdn.vibethemes.com/demodata/'.$style;
		...
		public function _get_json( $file ) {
			...
			if( !empty($path) ){
				...
				$theme_style = 'https://cdn.vibethemes.com/demodata/' . basename($style) .'/';
		...
		public function _content_setup_users(){
			...
			if($current_style  == 'demo_4_academy'){
				...
				$file_name = 'https://cdn.vibethemes.com/demodata/' . basename($current_style) .'/users.csv';
