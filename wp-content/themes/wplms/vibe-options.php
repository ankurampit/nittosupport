...
$sections[] = array(
				...
				'desc' => '<p class="description">'.sprintf(__('Welcome to %s Theme Options panel. ','vibe'),THEME_FULL_NAME).'</p>
                                    <ol>
                                        <li>'.__('See Theme documentation : ','vibe').'<a href="https://docs.wplms.io/" class="button">Official WPLMS Documentation</a></li> 
                                        ...
                                        <li>'.__('How to Update? Facing Issues while updating?','vibe').' <a href="https://www.envato.com/lp/market-plugin/"> updating WPLMS.</a></li>     
                                    </ol>',
					'icon' => 'menu',
                    'fields' => array(
                        array(
						...
						'sub_desc' => __('Required for Automatic Upgrades. Install Envato marketplace plugin for updates.', 'vibe').'<a href="https://www.envato.com/lp/market-plugin/">'.__('Download plugin','vibe').'</a>',
                            'std' => ''
						),
                    )
                );
