...
function themename_customize_register($wp_customize) {
    ...
    class Vibe_Customize_Slider_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <input type="text" class="slider_value text" data-min="<?php echo (!empty($this->min)?esc_html( $this->min ):''); ?>" data-max="<?php echo (!empty($this->max)?esc_html( $this->max ):''); ?>" <?php $this->link(); ?> value="<?php echo vibe_sanitizer($this->value()); ?>" />
