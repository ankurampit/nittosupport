...
class WPLMS_Init{
    ...
    */
    ...
    function course_category($args){
        ...
        global $wp_query;
        if(is_tax() &&  !empty($wp_query->query_vars) && !empty($wp_query->query_vars['course-cat'])){
...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.14.3.4.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '14.3.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
        ...
        array(
            'name'                  => 'Buddypress Classic', // The plugin name
            'slug'                  => 'bp-classic', // The plugin slug (typically the folder name)
            'source'                => 'https://downloads.wordpress.org/plugin/bp-classic.1.4.0.zip', // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '1.4.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
            'file'                  => 'bp-classic/class-bp-classic.php',
        ),
        array(
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/elementor.3.19.2.zip',
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
