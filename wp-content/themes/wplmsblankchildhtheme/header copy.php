...
<link href="<?php echo get_stylesheet_directory_uri() . '/assets/css/dealer-resources.css' ?>" rel="stylesheet">
<link href="<?php echo get_stylesheet_directory_uri() . '/assets/css/training.css' ?>" rel="stylesheet">
