    ...
    <div class="catalogues-section">
        ...
        <div id="new-catalogue-form" style="display:none; margin-bottom:30px;">
            ...
            acf_form([
                ...
                'field_groups' => ['group_684932feea2da'],
                ...
                <tbody>
                    ...
                    if ($query->have_posts()) :
                        ...
                        while ($query->have_posts()) :
                            ...
                            $short_description_english = get_post_meta($post_id, 'sell_sheets_brochures_short_description_english', true);
                            $short_description_french = get_post_meta($post_id, 'sell_sheets_brochures_short_description_french', true);

                            /* ===== GROUP FIELD ===== */
                            $thumb_en = get_post_meta($post_id, 'sell_sheets_brochures_thumb_english', true);
                            $thumb_fr = get_post_meta($post_id, 'sell_sheets_brochures_thumb_french', true);
                            $pdf_en   = get_post_meta($post_id, 'sell_sheets_brochures_pdf_english', true);
                            $pdf_fr   = get_post_meta($post_id, 'sell_sheets_brochures_pdf_french', true);
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <!-- DESCRIPTION -->
                                <td>
                                    <?php if ($short_description_english) : ?>
                                        <p><strong><?php echo esc_html($short_description_english); ?>
                                            </strong></p>
                                    <?php endif; ?>
                                    ...
                                    <?php if ($short_description_french) : ?>
                                        <p><strong><?php echo esc_html($short_description_french); ?>
                                            </strong></p>
                                    <?php endif; ?>
    ...
    function confirmDelete() {
        ...
        fetch('<?php echo admin_url('admin-ajax.php'); ?>', {
                ...
                body: new URLSearchParams({
                    action: 'delete_brochure_post',
                    post_id: postIdToDelete,
                    nonce: '<?php echo wp_create_nonce('delete_brochure_nonce'); ?>'
                })
            })
            .then(res => res.json())
            .then(res => {
