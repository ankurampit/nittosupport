                ...
                <tbody>
                    ...
                    if ($query->have_posts()):
                        while ($query->have_posts()):
                            ...
                            $img_en   = get_post_meta($post_id, 'logo_jpg_version_english_:', true);
                            $img_fr   = get_post_meta($post_id, 'logo_jpg_version_french_:', true);
                            $title_en = get_post_meta($post_id, 'logo_name_english_:_', true);
                            $title_fr = get_post_meta($post_id, 'logo_name_french_:', true);
                            ...
                            if (empty($img_en) && empty($img_fr) && empty($title_en) && empty($title_fr)) {
                                continue;
                            }
                    ?>
                        ...
                        <tr>
                            <td colspan="5" style="text-align:center; opacity:0.7;">No Nitto Logos found.</td>
                        </tr>
