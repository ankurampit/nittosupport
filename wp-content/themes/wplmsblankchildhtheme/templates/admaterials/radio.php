...
<div class="main-table">
    <div class="table-header">
        ...
        <button class="add-new-ad-button btn btn-primary" onclick="addNewAd('add_new')" id="print-ads-btn">Add New Radio</button>
                ...
                <tbody id="materials-sortable">
                    ...
                    if ($query->have_posts()) :
                        while ($query->have_posts()) :
                            ...
                            $mp3_en   = get_post_meta($post_id, 'picture_jpeg_version_english', true);
                            $mp3_fr = get_post_meta($post_id, 'picture_jpeg_version_french_', true);
                            ...
                            if (!empty($mp3_en)) {
                                $audio_en = is_array($mp3_en) ? $mp3_en['url'] : wp_get_attachment_url($mp3_en);
                            }

                            if (!empty($mp3_fr)) {
                                $audio_fr = is_array($mp3_fr) ? $mp3_fr['url'] : wp_get_attachment_url($mp3_fr);
                            }
