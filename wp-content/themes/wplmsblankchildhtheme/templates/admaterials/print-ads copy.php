                ...
                <tbody>
                    ...
                    if ($query->have_posts()) :
                        while ($query->have_posts()) :
                            ...
                            $img_en   = get_post_meta($post_id, 'picture_jpeg_version_english_', true);
                            $img_fr   = get_post_meta($post_id, 'picture_jpeg_version_french_', true);
                            $title_en = get_post_meta($post_id, 'do_not_use_after_title_english__', true);
                            $title_fr = get_post_meta($post_id, 'do_not_use_after_title_french_', true);
