...
/**
 * Template Name: Television and Video
...
<div class="main-table">
    <div class="table-header">
        <a class="header-ads">Television and Video</a>
        <button class="add-new-ad-button btn btn-primary" onclick="addNewAd('add_new')" id="print-ads-btn">Add New Television and Video</button>
        ...
        <div class="clearfix" id="new-ad-form" style="display:none;">
            ...
            add_filter('acf/load_field/name=material_term_slug', function ($field) {
                $field['value'] = 'television-and-video';
                return $field;
            });
            ...
            acf_form([
                ...
                'field_groups' => ['group_6926c30609aa7'],
                'submit_value' => 'Create Television and Video',
