            ...
            <tbody>
                ...
                if ($query->have_posts()) :
                    while ($query->have_posts()) :
                        ...
                        $img_en   = get_post_meta($post_id, 'you_tube_link_english_:', true);
                        $img_fr   = get_post_meta($post_id, 'you_tube_link_french_:', true);
                        ...
                        if (empty($title_en) && empty($title_fr)) {
                            continue;
                        }
                ?>
                    ...
                    ?>
                    <tr>
                        <td colspan="5" style="text-align:center; opacity:0.7;">No Television & Video materials found.</td>
                    </tr>
                <?php
                endif;
                wp_reset_postdata();
