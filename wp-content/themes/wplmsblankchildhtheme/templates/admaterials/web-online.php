...
<div class="main-table">
    <div class="table-header">
        <a class="header-ads">Web and Online</a>
        <button class="add-new-ad-button btn btn-primary" onclick="addNewAd('add_new')" id="print-ads-btn">Add New Web & Online</button>
        ...
        <div class="clearfix" id="new-ad-form" style="display:none;">
            ...
            acf_form([
                ...
                'field_groups' => ['group_698c4ac27ba82'],
                'submit_value' => 'Create Web & Online',
                ...
                <tbody id="materials-sortable">
                    ...
                    if ($query->have_posts()) :
                        while ($query->have_posts()) :
                            ...
                            $img_en   = get_post_meta($post_id, 'banner_image_english', true);
                            $img_fr   = get_post_meta($post_id, 'banner_image_french', true);
                            $title_en = get_post_meta($post_id, 'web_banner_name_english', true);
                            $title_fr = get_post_meta($post_id, 'web_banner_name_french', true);
