    ...
    */
	...
	function get_course_unfinished_unit($course_id,$user_id=null){
		...
		if(empty($user_id))
	  	...
	  	$unit_id = apply_filters('wplms_plugin_get_course_unfinished_unit',$unit_id,$course_id,$user_id);
	  	$key = apply_filters('wplms_plugin_get_course_unfinished_unit_key',$key,$unit_id,$course_id,$user_id);
	    ...
	    if(function_exists('bp_course_check_unit_complete')){ 
	  	...
	  	$drip_enable= apply_filters('wplms_course_drip_switch',get_post_meta($course_id,'vibe_course_drip',true),$course_id,$user_id);
