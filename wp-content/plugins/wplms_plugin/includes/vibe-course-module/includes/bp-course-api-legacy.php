...
if ( ! defined( 'BP_COURSE_API_NAMESPACE_LEGACY' ) )
	define( 'BP_COURSE_API_NAMESPACE_LEGACY', 'wplms/v1' );

if ( ! class_exists( 'BP_Course_API_Legacy' ) ) {
	...
	class BP_Course_API_Legacy {
		...
		private static function includes() {
			...
			require_once dirname( __FILE__ ) . '/api/v3/class-api-auth-server.php';
			require_once dirname( __FILE__ ) . '/api/v3/class-api-controller.php';
			require_once dirname( __FILE__ ) . '/api/v3/class-api-user-controller.php';
			require_once dirname( __FILE__ ) . '/api/v3/class-api-course-controller.php';
			require_once dirname( __FILE__ ) . '/api/v3/class-api-scorm-controller.php';
			include_once dirname( __FILE__ ) . '/api/v3/class-api-commissions.php';
			include_once dirname( __FILE__ ) . '/api/v3/class-api-instructor-controller.php';
	...
	add_action( 'init', array( 'BP_Course_API_Legacy', 'initialize' ),99);
	add_action( 'admin_notices', array( 'BP_Course_API_Legacy', 'missing_wp_api_notice' ) );
}
