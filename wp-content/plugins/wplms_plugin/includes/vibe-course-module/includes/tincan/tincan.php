...
if(!class_exists('wplms_vibe_tincan')){



    class wplms_vibe_tincan{
        ...
        function articulate_payload($record,$referer){
            ...
            bp_course_record_activity(array(
              'action' => __('Student ','wplms').$record['verb'].' '.$object,
              'content' => __('Student ','wplms').bp_core_get_userlink( $user_id ).' '.$record['verb'].' '.$object .__(' in ','wplms').$course,
              'type' => $record['verb'],
        ...
        function parse_xml($object,$referer){
            ...
            $string = $wp_filesystem->get_contents( $tincanxml );
    ...
    add_action('init',function(){
        if(!class_exists('wplms_tincan')){
            $wplms_tincan = new wplms_vibe_tincan();
        }
    },1);
